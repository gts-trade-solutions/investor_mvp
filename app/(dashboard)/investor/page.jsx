                  ...
                  <div>
                    ...
                    <div className="flex items-center space-x-2 mt-1">
                      <span className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium
                        ${opportunity.stage === 'TO_CONTACT' ? 'bg-gray-100 text-gray-800' : 
                          opportunity.stage === 'CONTACTED' ? 'bg-blue-100 text-blue-800' :
                          opportunity.stage === 'MEETING' ? 'bg-yellow-100 text-yellow-800' :
                          opportunity.stage === 'DILIGENCE' ? 'bg-purple-100 text-purple-800' :
                          opportunity.stage === 'COMMITTED' ? 'bg-green-100 text-green-800' :
