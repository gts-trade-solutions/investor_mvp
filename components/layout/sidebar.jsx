...
export function Sidebar() {
  ...
  const getNavigationItems = () => {
    // Determine role: prefer Supabase user, fall back to pathname/localStorage
    ...
    if (!role) {
      ...
      else if (typeof window !== 'undefined') role = (localStorage.getItem('currentUserRole') || 'FOUNDER').toUpperCase()
      else role = 'FOUNDER'
    }
